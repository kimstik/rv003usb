...
- [x] Трек BOOT-B, статический device-side ГОТОВ (bf54099): bootloader_wg015_dfu/
      2748Б/4К (гейт 3000), DFU-машина на OTHER_CONTROL, DNLOAD через setup_request=2,
      флеш-запись в TCM (дизасм: самодостаточна), bwPollTimeout 50/8 мс, CRC32-гейт
      приложения (samd11-конвенция length@+0x10), UPLOAD есть, tools/wg015mkdfu.py
      (selfcheck зелёный). Осталось HW: интероп с dfu-util, ENDPOINTS=1 на живом хосте,
      времена erase/program. Выделение в отдельный бранч — по желанию (cherry-pick).
